<%-- 
    ...
    Created on : Aug 25, 2019, 1:02:37 AM
    Author     : Akash
--%>
...
<html>
    ...
    <body>
        <%
        int intr_uid=Integer.parseInt(request.getParameter("uid"));
        Class.forName("com.mysql.jdbc.Driver");
        Connection con=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/desdb","root","");
        PreparedStatement stmt=con.prepareStatement("select * from user where uid='"+intr_uid+"'");
        ResultSet rs=stmt.executeQuery();
        while(rs.next())
        {
            String unmae=rs.getString("uname");
   ...
   <div class="row">
            ...
            <div class="col s12 m12 l8">
                <div class="z-depth-4" style="max-height: 1400px; padding: 20px;">
                    ...
                    <%  PreparedStatement s=con.prepareStatement("select interest_id from allinterest where uid='"+intr_uid+"'");
